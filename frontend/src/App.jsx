    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/formations/catalog" element={
            <ProtectedLayout>
              <TrainingsPage />
            </ProtectedLayout>
          } />

          <Route path="/formations/launch" element={
            <ProtectedLayout>
              <LaunchTrainingPage />
            </ProtectedLayout>
          } />

          <Route path="/formations/active" element={
            <ProtectedLayout>
              <ActiveTrainingsPage />
            </ProtectedLayout>
          } />

          <Route path="/formations/packs" element={
            <ProtectedLayout>
              <PacksPage />
            </ProtectedLayout>
          } />
          ...
          <Route path="/reports/student-debt" element={
            <ProtectedLayout>
              <StudentDebtPage />
            </ProtectedLayout>
          } />
